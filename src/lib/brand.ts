...
export const BRAND_ASSETS = [
  ...
  {
    id: "scheduler",
    file: "/marketing/scheduler-preview.png",
    title: "Scheduler Preview",
    description: "Vista previa de agenda multi-red",
    size: "PNG + SVG",
  ...
  {
    id: "automation",
    file: "/marketing/automation-preview.png",
  ...
  {
    id: "campaign",
    file: "/marketing/campaign-launch.png",
  ...
  {
    id: "hero-mkt",
    file: "/marketing/hero-banner.png",
    title: "Hero marketing",
    description: "Banner hero para Marketing Hub",
    size: "PNG + SVG",
  ...
  },
  {
    ...
    title: "App preview",
    description: "Captura / preview del producto",
    size: "PNG",
    platform: "Docs / store",
    kind: "promo" as const,
  },
...
export const BRAND_USAGE_RULES = [
  ...
  "Pack gráfico: /public/brand, /public/marketing, /public/design (ver ASSETS.md).",
] as const;
